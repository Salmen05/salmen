...
<head>
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="/img/logo/3.png">
    ...
    <div class="row justify-content-md-center">
      ...
      if ($listaProduto != 'Vazio') {
        foreach ($listaProduto as $produtoRetorno) {
          ...
          if ($genero == 'Feminino' and $produto == 'saia') {
      ?>
            <div class="col-md-3">
              <div class="card">
                <img src="./img/produto/saia/<?php echo $foto ?>" class="card-img-top" alt="...">
                <div class="card-body">
