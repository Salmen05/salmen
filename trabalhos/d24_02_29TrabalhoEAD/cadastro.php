...
<body style="background-image: url('./img/cadphoto-transformed.jpeg');background-size: cover;background-repeat: no-repeat;">
  <div class="container-fluid" width="100%">
    <div class="row">
      <div class="card col-md-4 sm-1 bg-white card left2" height="200%">
        <br>
        <h1>Cadastro</h1>
        <hr>
        <form action="redirect.php" method="POST" name="cadastroUsuario">
          <div class="input-container">
            ...
            <input class="input" type="text" id="impnomecad" name="impnomecad" required="required" placeholder="Informe o nome que deseja ser chamado">
          </div>
          <div class="input-container">
            <label class="label" for="impemailcad">Email:</label>
            <input class="input" type="email" id="impemailcad" name="impemailcad" required="required" placeholder="exemplo@gmail.com">
          </div>
          <div class="input-container">
            <label class="label" for="impsenhacad">Senha:</label>
            <input class="input" type="password" id="impsenhacad" name="impsenhacad" required="required" placeholder="Digite uma senha de 8 digitos ou mais">
          </div>
          <div class="input-container">
            <label class="label" for="impcpfcad">CPF: </label>
            <input class="input" type="number" id="impcpfcad" name="impcpfcad" maxlength="15" minlength="11" required="required" placeholder="Digite seu CPF sem pontos ou traços">
          </div>
          <div class="checkbox-container">
            <input type="checkbox" id="remember-me" name="remember-me" required="required">
            <label for="remember-me">Concordo com os termos de uso</label>
          </div>
        ...
        <div class="button-container">
          ...
          <center><a href="index.php" style="color:black">Ja possui uma conta ? <b>Logue</b></a></center>
        </div>
      </div>
    </div>
  </div>
