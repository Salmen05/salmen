...
<body>
  ...
  <div class="container-fluid">
    ...
    <nav class="navbar navbar-white bg-white">
      <div class="container-fluid ">
        <button class="navbar-toggler " type="button" data-bs-toggle="collapse" style="border-color:black"
...
<div class="container">
    ...
    <h2 class="text-center">Estilo Feminino</h2>
      ...
      if ($listaProduto != 'Vazio') {
        foreach ($listaProduto as $produtoRetorno) {
          ...
          if ($genero == 'Feminino' && $produto != 'chapeu' && $produto != 'tenis') {
      ?>
            <div class="col-md-3 col-sm-6 mt-3">
              <div class="card">
                <img src="./img/produto/fem/<?php echo $foto ?>" class="card-img-top img-fluid" alt="...">
                <div class="card-body">
